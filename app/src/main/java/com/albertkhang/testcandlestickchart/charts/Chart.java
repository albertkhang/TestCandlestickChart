...
import com.albertkhang.testcandlestickchart.animation.Easing.EasingFunction;
import com.albertkhang.testcandlestickchart.components.Description;
import com.albertkhang.testcandlestickchart.components.IMarker;
import com.albertkhang.testcandlestickchart.components.Legend;
import com.albertkhang.testcandlestickchart.components.XAxis;
import com.albertkhang.testcandlestickchart.data.ChartData;
import com.albertkhang.testcandlestickchart.data.Entry;
import com.albertkhang.testcandlestickchart.formatter.DefaultValueFormatter;
import com.albertkhang.testcandlestickchart.formatter.ValueFormatter;
import com.albertkhang.testcandlestickchart.highlight.ChartHighlighter;
import com.albertkhang.testcandlestickchart.highlight.Highlight;
import com.albertkhang.testcandlestickchart.highlight.IHighlighter;
import com.albertkhang.testcandlestickchart.interfaces.dataprovider.ChartInterface;
import com.albertkhang.testcandlestickchart.interfaces.datasets.IDataSet;
import com.albertkhang.testcandlestickchart.listener.ChartTouchListener;
import com.albertkhang.testcandlestickchart.listener.OnChartGestureListener;
import com.albertkhang.testcandlestickchart.listener.OnChartValueSelectedListener;
import com.albertkhang.testcandlestickchart.renderer.DataRenderer;
import com.albertkhang.testcandlestickchart.renderer.LegendRenderer;
...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected void setupDefaultFormatter(float min, float max) {
        Log.d(FLOW_TAG, "Chart setupDefaultFormatter");
    ...
    public Legend getLegend() {
        Log.d("chart.getLegend", "mLegend " + mLegend.getEntries().length);
        return mLegend;
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        Log.d(FLOW_TAG, "Chart onSizeChanged");
